...
public class PatientNextOfKinFactory {
    ...
    public static PatientNextOfKin getPatientNextOfKin(String nOKId, String nOKname, String nOKLastName,String nOKRelation, int contact) {
        return new PatientNextOfKin.Builder().patientNOKId(nOKId)
